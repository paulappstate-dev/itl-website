...
function buildFullSigHTML() {
  ...
  <tr>
    ...
    <td style="vertical-align:top;font-family:Helvetica,Arial,sans-serif;font-size:12px;line-height:1.5;color:#010101;padding:2px 0;">
      <div style="font-size:15px;font-weight:700;letter-spacing:-0.1px;line-height:1.15;color:#010101;">Paul Wallace, <span style="font-weight:400;color:#4c4847;">Ph.D.</span></div>
    ...
    <div style={{ maxWidth: 1040, margin: '0 auto', padding: '40px 32px 80px', fontFamily: 'Helvetica, Arial, sans-serif', color: FS_BLACK }}>
      <div style={{ marginBottom: 36 }}>
        ...
        <p style={{ margin: 0, maxWidth: 760, fontSize: 14, lineHeight: 1.6, color: FS_DARK }}>
          ...
          App State Gold rule, a gold “/” separator between Reich College and App State, and gold <span style={{ background: FS_GOLD, color: FS_BLACK, padding: '1px 6px', fontWeight: 700, fontSize: 11, letterSpacing: 1.4 }}>E</span>&nbsp;/&nbsp;<span style={{ background: FS_GOLD, color: FS_BLACK, padding: '1px 6px', fontWeight: 700, fontSize: 11, letterSpacing: 1.4 }}>P</span> chips on the contact line.
